...
@section('contenido')
    <div class="md:flex md:justify-center md:gap-10 md-items-center">
        <div class="md:w-6/12 p-5 ">
            <img src="{{ asset('img/registrar.jpg') }}" alt="Imagen login de usuarios" loading="lazy" class="object-cover" />
        </div>
            ...
            <form action="{{ route('register') }}" method="post" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="name" name="name" placeholder="Tu nombre"
                        class="border border-gray-300 p-3 w-full rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('name') border-red-500 @enderror"
                        value="{{ old('name') }}" />
                    @error('name')
                ...
                <div class="mb-5">
                    ...
                    <input type="email" id="email" name="email" placeholder="Tu Email"
                        class="border border-gray-300 p-3 w-full rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('email') border-red-500 @enderror"
                        value="{{ old('email') }}" />
                    @error('email')
                        <p class="text-red-500">{{ $message }}</p>
                    @enderror
